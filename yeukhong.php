...
<title>[Cao Văn Hoàng] Gửi Tặng Cho Bé Nhung Nè<3</title>
...
<table width="100%"><tbody><tr><td width="7%"><td align=center>
	...
	<script language="JavaScript">
		...
		function al() {
		alert("Cảm ơn bé Nhung nhiều lắm!!");
		alert("Đã làm cho trái tim tớ hết đơn coi và lạnh giá");
		alert("Nắm tay tớ nha, mãi mãi của nhau nha ahihi, vì tớ yêu cậu nhìu lắm .Tình cảm tớ dành cho cậu là thật lòng <3 ");
		alert("Đi nào....  !!!!");
		}
	</script>
<ul id="scroll">
...
<font face="Arial&gt" color="#00d00a" size="4">
									...
									Có một người muốn đi tiếp con đường và bước từng bước thật chậm cùng một người <br><br>  <br> 
                                                                        									Người đó là [Nguyễn Thị Tuyết Nhung] đó ^_^ ...
...
<br><center><a href="camon.php" class="myButton">Xem Tiếp>></a></center>
</td></tr>
<tr><td>
</object></td></tr>
...
<p id="copy" onClick="window.open('https://www.facebook.com/HOANG.PORO.2','')">© CAO VĂN HOÀNG - 2021
</p>
<script>
var txt="[Hoàng] gửi tặng [Nhung] ";
var espera=100;
var refresco=null;
